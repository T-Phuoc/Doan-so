...
btGuess.onclick = () => {
  ...
  if (guess === mysteryNumber) {
    ...
    lbResultOnWin.innerHTML = `Con số bí mật là ${mysteryNumber}`;

    new Audio("./assets/correct.mp3").play();
    startConfetti();
  } else if (guess < mysteryNumber) {
    lbPrompt.innerHTML = "còn hơi thấp đó";
    // play sound wrong.mp3
    new Audio("./assets/xi-hoi.mp3").play();
  } else {
    lbPrompt.innerHTML = "cao quá rồi";
